...
Operator text, supplied 2026-09-05. This file replaces the gating placeholder
INT committed earlier the same day; that placeholder is void.
...
supersedes:  the gating placeholder committed earlier the same day
