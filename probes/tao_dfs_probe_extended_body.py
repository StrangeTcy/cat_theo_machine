...
print("DEBUG-EXT: applicability multiprocessing enabled with", multiprocessing.cpu_count(), "logical processors available")
...
trace_path = r"Q:\hyge\tao_dfs_probe_extended_traceback.txt"
